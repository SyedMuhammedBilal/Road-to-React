...
in the lifecycle method componentDidMount(). This method is called after a component 
is mounted to the DOM. Any calls to setState() here will trigger a re-rendering of your component. 
...
render the value of activeUsers in the h1 after the text Active Users:. 
...
class MyComponent extends React.Component {
    ...
    render() {
        return (
            <div>
                <h1> Active User: {this.state.activeUser} </h1>
            </div>
        )
    }
}
